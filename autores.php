...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">NEWBLARY</a>
...
if ($resultado->num_rows > 0) {
    // Mostrar datos de cada autor en tarjetas
    while($fila = $resultado->fetch_assoc()) {
        echo "<div class='author-card'>";
        echo "<h2>".$fila["nombre"]." ".$fila["apellido"]."</h2>";
        echo "<p><strong>Teléfono:</strong> ".$fila["telefono"]."</p>";
        echo "<p><strong>Dirección:</strong> ".$fila["direccion"].", ".$fila["ciudad"].", ".$fila["estado"].", ".$fila["pais"].", ".$fila["cod_postal"]."</p>";
        echo "</div>";
    }
} else {
